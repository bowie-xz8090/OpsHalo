...
- The independent public repository is `https://github.com/bowie-xz8090/OpsHalo`, with `main` as its default branch and OpsHalo-specific About metadata. No release, installer, package, or automatic publishing workflow was created.
