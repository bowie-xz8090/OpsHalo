...
export async function executeToolCall (toolName, args) {
  ...
  if (store.config?.agentModeEnabled) {
    throw new Error('Legacy Renderer Agent tool execution is disabled while Agent mode is enabled; use the Main-process Tool Gateway session.')
  }
  switch (toolName) {
