...
import { isAgentAiConfigMissing, isApiAiConfigMissing } from '../components/ai/ai-config-props'
...
export default Store => {
  ...
  Store.prototype.aiConfigMissing = function () {
    if (window.store.config.aiBackendType === 'codex_subscription') {
      return true
    }
    return isApiAiConfigMissing(window.store.config)
  }

  Store.prototype.agentAiConfigMissing = function () {
    return isAgentAiConfigMissing(window.store.config)
  }
